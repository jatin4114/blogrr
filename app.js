...
let currentView = 'auth'; // possible values: 'auth', 'myBlogs', 'explore'
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function openEditPopup(blog) {
        ...
        const editForm = popup.querySelector('#edit-blog-form');
    ...
    async function addComment(event, blogId, isModal = false) {
    ...
    function displaySortFilterPanel(show) {
        let panel = document.querySelector('.sort-filter-panel');
    ...
    function showBlogsPage(type = 'my') {
        ...
        setTimeout(() => {
            ...
            menuToggle.classList.remove('hidden'); // Show hamburger button
    ...
    async function loadAndDisplayBlogs(type) {
        const blogsGrid = document.getElementById('blogs-grid');
    ...
    async function loadBlogs(type = 'my', filters = {}) {
        try {
    ...
    function displayBlogs(blogs, type) {
        const blogsGrid = document.getElementById('blogs-grid');
        const blogsTitle = document.querySelector('.blogs-container h2');
        const blogsSubtitle = document.querySelector('.blogs-subtitle');
    ...
    function openCreateBlogPopup() {
        ...
        // Handle form submission
        const createForm = popup.querySelector('#create-blog-form');
        createForm.onsubmit = async (e) => {
            e.preventDefault();
            const title = createForm.querySelector('#create-title').value;
            const content = createForm.querySelector('#create-content').value;
            const category = createForm.querySelector('#create-category').value;
